...
public class CartItemController {
    ...
    public ResponseEntity<ApiResponse> updateCartItem(@PathVariable Long cardId, @PathVariable Long itemId, @RequestParam int quantity){
        cartItemService.updateItemQuantity(cardId, itemId, quantity);
